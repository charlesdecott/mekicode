...
6 574 lignes) en 11 modules + 1 config.yaml (2 041 lignes), sans perte de feature.
...
|---|---|---|---|---|
| core-py | src_scratch/core.py | Fondations | 134 | core + s15 + s16 |
| tools-py | src_scratch/tools.py | Fondations | 272 | core + s02 + s08 + s14 |
| loop-py | src_scratch/loop.py | Fondations | 247 | s01 + s13 + s15 + s16 + s18 + s19 + s20 |
...
| agents-py | src_scratch/agents.py | Multi-agents | 217 | s04 + s09 + s10 + s11 (workers) |
| worktree-py | src_scratch/worktree.py | Intégration | 172 | s12 + s23 |
| sessions-py | src_scratch/sessions.py | Intégration | 121 | s17 |
| mcp-runtime-py | src_scratch/mcp_runtime.py | Intégration | 146 | s21 |
| main-py | src_scratch/main.py | Intégration | 185 | s17 (REPL) + assemblage |
