...
**Avancement `packages/` vs s01–s23 : ≈ 3 / 23 ≈ 13 %** (s01 + s02 + s13 complets). C'est volontaire :
...
- `views.py` : rendu des bulles (markdown), des blocs `[bash]`, du streaming (caret), de l'historique.
